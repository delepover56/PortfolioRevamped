    ...
    <aside className="sticky top-[5%] h-[max-content] select-none">
      <div className="w-[100%] py-[10%] gap-[10px] flex flex-col items-center justify-start bg-[#0f0f0f85] rounded-xl border border-[#00ff5e66] backdrop-blur-md">
        ...
        <div className="w-full flex justify-center items-center mt-4">
          <a
            href="/src/assets/Documents/myResume.pdf"
            className="bg-[#053a00ff] rounded-xl border border-[#00ff5e66] backdrop-blur-md py-[10px] px-[20px] text-[#00ff5e] poppins-semibold hover:border-[#053a00ff] hover:bg-[#00ff5e] hover:text-[#053a00ff] transition-all duration-400 hover:shadow-[0px_0px_50px_10px_rgba(5,_58,_0,_1)]"
          >
            Download Resume
          </a>
        </div>
